...
let saperator=document.createElement("hr")
document.body.append(heading)
document.body.append(saperator)

let main_container=document.createElement("div")
main_container.style.display="flex"
document.body.append(main_container)
main_container.style.border="2px solid black"
main_container.style.padding="5px 5px 4px 20px"
main_container.style.justifyContent="spacearound"
main_container.style.flexWrap="wrap"
main_container.style.gap="5px"
// main_container.style.gap="10px"
...
products.forEach(function(val,i,a){
    ...
    prop_id.innerText=val.id
    // let discription=document.createElement("p")
    // discription.innerText=`Discription ${val.description}`
    // card.append(discription)
    let image=document.createElement("img")
    image.setAttribute("src",val.image)
    image.style.width="40%"
    image.style.height="40%"
    let pro_rate=document.createElement("p")
   pro_rate.innerText=val.rating.rate
   card.append(image,prop_id,pro_title,pro_rate)
    // document.body.append(card)
     main_container.append(card)
    card.style.border="2px solid #e2e2e2"
